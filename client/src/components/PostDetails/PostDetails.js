        ...
        <Paper style={{padding : '20px',borderRadius: '15px'}} elevation={6}>
            <div className={classes.card}>
                <div className={classes.section}>
                    ...
                    <Typography gutterBottom variant="body1" component="p">{post.desc}</Typography>
                ...
                {recommendedPosts.length !== 0 && (
                    <div className={classes.section}>
                        ...
                        <div className={classes.recommendedPosts}>
                            {recommendedPosts.map(({ title, desc, name, selectedFile, likes, _id }) => (
                                <div style={{ margin : '20px', cursor : 'pointer'}} onClick={() => openPost(_id)} key={_id} >
                                    <Typography gutterBottom variant="h6">{title}</Typography>
                                    <Typography gutterBottom variant="subtitle1">{name}</Typography>
                                    <Typography gutterBottom variant="subtitle2">{desc}</Typography>
